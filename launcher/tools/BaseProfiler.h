...
class BaseProfiler : public BaseExternalTool {
    Q_OBJECT
   public:
    explicit BaseProfiler(SettingsObject* settings, BaseInstance* instance, QObject* parent = nullptr);
...
class BaseProfilerFactory : public BaseExternalToolFactory {
   public:
    virtual BaseProfiler* createProfiler(BaseInstance* instance, QObject* parent = nullptr);
};
