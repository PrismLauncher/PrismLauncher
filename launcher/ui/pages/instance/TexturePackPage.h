...
public:
    ...
    {
        return hello_developer_i_am_here_to_kindly_tell_you_that_the_following_variable_is_actually_a_member_instance->traits().contains("texturepacks");
    }
   ...
   public slots:
    bool onSelectionChanged(const QModelIndex& current, const QModelIndex& previous) override
    {
        ...
        auto& rp = static_cast<TexturePack&>(hello_developer_i_am_here_to_kindly_tell_you_that_the_following_variable_is_actually_a_member_model->at(row));
