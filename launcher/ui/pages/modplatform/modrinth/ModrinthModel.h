...
class ModpackListModel : public QAbstractListModel {
   ...
   public:
    ...
    [[nodiscard]] bool hasActiveSearchJob() const { return m_jobPtr && m_jobPtr->isRunning(); }
    [[nodiscard]] Task::Ptr activeSearchJob() { return hasActiveSearchJob() ? m_jobPtr : nullptr; }
