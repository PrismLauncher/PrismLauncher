...
void FlamePage::triggerSearch()
{
    ...
    m_listModel->searchWithTerm(m_ui->searchEdit->text(), m_ui->sortByBox->currentIndex(), m_filterWidget->getFilter(),
        ...
        callbacks.on_succeed = [this, curr, addonId](auto& doc) {
            ...
            for (auto version : m_current->versions) {
                ...
                auto mcVersion = !version.mcVersion.isEmpty() && !version.version.contains(version.mcVersion.first())
                                     ...
                                     : "";
                m_ui->versionSelectionBox->addItem(QString("%1%2%3").arg(version.version, mcVersion, release_type),
