...
void APIPage::loadSettings()
{
    ...
    int pasteTypeIndex = ui->pasteTypeComboBox->findData(conf.pastebinType.toInt());
    if (pasteTypeIndex == -1) {
...
void APIPage::applySettings()
{
    ...
    conf.pastebinType = static_cast<PasteUpload::Type>(ui->pasteTypeComboBox->currentData().toInt());
