...
void Application::performMainStartupAction()
{
    ...
    if (!m_instanceIdToLaunch.isEmpty()) {
        ...
        if (inst) {
            ...
            launch(inst, true, targetToJoin, accountToUse);
            return;
        }
    }
...
void Application::messageReceived(const QByteArray& message)
{
    ...
    if (command == "activate") {
        ...
        launch(instance, true, serverObject, accountObject);
    } else {
...
bool Application::launch(InstancePtr instance, bool online, MinecraftTarget::Ptr targetToJoin, MinecraftAccountPtr accountToUse)
{
    if (m_updateRunning) {
