...
const QMap<QString, ModloaderMapEntry> Component::KNOWN_MODLOADERS = {
    { "net.neoforged",
      { Platform::ModLoader::NeoForge, { "net.minecraftforge", "net.fabricmc.fabric-loader", "org.quiltmc.quilt-loader" } } },
    { "net.minecraftforge", { Platform::ModLoader::Forge, { "net.neoforged", "net.fabricmc.fabric-loader", "org.quiltmc.quilt-loader" } } },
    { "net.fabricmc.fabric-loader",
      { Platform::ModLoader::Fabric, { "net.minecraftforge", "net.neoforged", "org.quiltmc.quilt-loader" } } },
    { "org.quiltmc.quilt-loader", { Platform::ModLoader::Quilt, { "net.minecraftforge", "net.neoforged", "net.fabricmc.fabric-loader" } } },
    { "com.mumfrey.liteloader", { Platform::ModLoader::LiteLoader, {} } }
};
