...
Platform::ResourceType identify(QFileInfo file)
{
    if (file.exists() && file.isFile()) {
        if (ModUtils::validate(file)) {
            ...
            return Platform::ResourceType::ShaderPack;
        } else {
