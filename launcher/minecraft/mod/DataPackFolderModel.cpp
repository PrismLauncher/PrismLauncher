...
{
    m_columnNames = QStringList({ "Enable", "Image", "Name", "Version", "Pack Format", "Last Modified", "Size", "File Name" });
    m_columnNamesTranslated = QStringList(
        { tr("Enable"), tr("Image"), tr("Name"), tr("Version"), tr("Pack Format"), tr("Last Modified"), tr("Size"), tr("File Name") });
    m_columnSortKeys = { SortType::Enabled,    SortType::Name, SortType::Name, SortType::Version,
                         SortType::PackFormat, SortType::Date, SortType::Size, SortType::Filename };
