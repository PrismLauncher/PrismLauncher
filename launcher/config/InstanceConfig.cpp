...
std::optional<InstanceConfig> InstanceConfig::load(const QString& path)
{
    ...
    const auto useLatestMinecraftVersion = value("UseLatestMinecraftVersion", false);
    if (useLatestMinecraftVersion) {
        conf.useLatestMinecraftVersionType = value("UseLatestMinecraftVersionType", QString("release"));
    }
