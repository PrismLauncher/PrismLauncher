...
struct InstanceConfig {
    static Result<InstanceConfig> load(const QString& path);

    static InstanceConfig loadDefaults();
    ...
    void regenerateUuid() { uuid = QUuid::createUuid().toString(QUuid::Id128); }
    ...
    std::optional<QString> useLatestMinecraftVersionType;

    QHash<QString, QHash<QString, bool>> uiColumnVisibility;
    QHash<QString, QHash<QString, int>> uiColumnSizes;
};
