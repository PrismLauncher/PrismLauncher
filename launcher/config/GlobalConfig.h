...
struct GlobalConfig {
    static Result<GlobalConfig> load(const QString& path);

    static GlobalConfig loadDefaults();
    ...
    struct MemoryOverrides {
        ...
        static MemoryOverrides defaults();
    ...
    QList<QString> modUpdateReleaseTypes;
