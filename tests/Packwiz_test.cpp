...
class PackwizTest : public QObject {
   ...
   private slots:
    ...
    void loadFromFile_Modrinth()
    {
        ...
        QCOMPARE(metadata.side, Platform::Side::ClientSide);
        ...
        QCOMPARE(metadata.provider, Platform::Provider::MODRINTH);
    ...
    void loadFromFile_Curseforge()
    {
        ...
        QCOMPARE(metadata.side, Platform::Side::UniversalSide);
        ...
        QCOMPARE(metadata.provider, Platform::Provider::FLAME);
